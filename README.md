...
A single-page, no-install task/point tracker for a roleplay server division. Every person's task counts, weekly totals, and activity history are tracked in one clean -right in your browser, no backend required.
